 ...
 * お名前バリデーションチェック
--------------------------------*/
$form_name.addEventListener('change', (e) => {
...
$form_name.addEventListener('input', (e) => {
  $form_name.setCustomValidity('');
  if($form_name.value==""){
    $form_name.setCustomValidity(' ');
    $form_name.classList.add("is-error");
...
--------------------------------*/
/* 入力後チェック */
$form_ruby.addEventListener('change', (e) => {
...
/* リアルタイムチェック(入力中はエラーを消す) */
$form_ruby.addEventListener('input', (e) => {
  $form_ruby.setCustomValidity('');
  if($form_ruby.value==""){
    $form_ruby.setCustomValidity(' ');
    $form_ruby.classList.add("is-error");
...
--------------------------------*/
/* 入力後チェック */
$form_email.addEventListener('change', (e) => {
...
/* リアルタイムチェック(入力中はエラーを消す) */
$form_email.addEventListener('input', (e) => {
  $form_email.setCustomValidity('');
  if($form_email.value==""){
    $form_email.setCustomValidity(' ');
    $form_email.classList.add("is-error");
